...
class Glyph(Enum):
    ...
    SHARE_ALT = "glyphicon-share_alt"
    RESIZE_FULL = "glyphicon-resize_full"
    RESIZE_SMALL = "glyphicon-resize_small"
    ...
    MENU_HAMBURGER = "glyphicon-menu-hambuger"
